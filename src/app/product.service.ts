...
export class ProductServices{
    ...
    constructor()
    {
        ...
        let p2 = new Product(2,"Moto G5 Pus","../assets/images/2.jpg",13999,"Mobile");
        let p3 = new Product(3,"Nokia 6","../assets/images/3.jpg",14999,"Mobile");
        let p4 = new Product(4,"Samsung Galaxy Note 8","../assets/images/4.jpg",67999,"Mobile");
        ...
        let p7 = new Product(7,"Canon DSLR","../assets/images/7.jpg",65000,"Camer");
        let p8 = new Product(8,"HP Printer","../assets/images/8.jpg",4000,"Printer");
        let p9 = new Product(9,"Apple Ipap","../assets/images/9.jpg",24900,"Tab");
